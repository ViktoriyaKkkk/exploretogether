	...
	return (
		<ModalLayout admin={true} func={()=> {
			...
			<div className='flex items-start justify-between p-4 border-b rounded-t border-gray'>
				<h3 className='text-lg place-self-center font-semibold text-white'>
			...
			<div className='px-6 space-y-3'>
				<label htmlFor='name' className='inline font-semibold text-white'>Name: </label>
				<input id='name' type='name' name='name' placeholder='name' autoComplete='name'
							 value={name} onChange={e => setName(e.target.value)}
							 className='block w-full text-sm px-4 p-1 mt-2 text-white bg-black border
			...
			<div className='px-6 pt-3 space-y-3'>
				<label htmlFor='email' className='inline font-semibold text-white'>Email: </label>
			...
			<div className='px-6 pt-3 space-y-3'>
				<label className='inline font-semibold text-white'>Role: </label>
			...
			<div className='px-6 pt-3 space-y-3'>
				<label className='inline font-semibold text-white'>Gender: </label>
			...
			<div className='px-6 pt-3 space-y-3'>
				<label htmlFor='socialNetwork' className='inline font-semibold text-white'>SocialNetwork: </label>
			...
			<div className='px-6 pb-6 pt-3 space-y-3'>
				<label htmlFor='info' className='inline font-semibold text-white'>Info: </label>
